...
- **PyTorch, TorchVision, timm** — EfficientNet-B0 training and inference.
- **Albumentations, OpenCV, Pillow** — JPEG, blur, resize, noise, colour, and crop transforms.
...
- **scikit-learn, pandas, Matplotlib, Seaborn** — metrics, robustness tables, and figures.
